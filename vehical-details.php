...
<?php }} ?>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="Source" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="Destination" required>
            </div>
            <div class="form-group">
  ...
  <select id="time" class="form-control" name="time" required>
    <option value="1">1 hour - 100 INR</option>
    <option value="2">2 hours - 200 INR</option>
    <option value="3">3 hours - 300 INR</option>
    <option value="4">4 hours - 400 INR</option>
    <option value="1">5 hour - 500 INR</option>
    <option value="2">6 hours - 600 INR</option>
    <option value="3">7 hours - 700 INR</option>
    <option value="4">8 hours - 800 INR</option>
    <option value="1">9 hour - 900 INR</option>
    <option value="2">10 hours - 1000 INR</option>
    <option value="3">11 hours - 1100 INR</option>
    <option value="4">12 hours - 1200 INR</option>
